...
A aplicação possui uma interface intuitiva e responsiva para gerar áudios em tempo real:

![Gemini Vox Interface Demo - Voice Selection and TTS Generation](docs/images/interface-demo.png)

**Visualização da Interface:**
- 🎤 **Seletor de Vozes**: Escolha entre 5+ vozes naturais em português
- ✍️ **Editor de Texto**: Campo com limite de 5.000 caracteres
- 🎙️ **Geração em Tempo Real**: Clique e ouça o áudio gerado
- 📊 **Dark Mode Profissional**: Design moderno e elegante
- 🎧 **Reprodução Integrada**: Player de áudio na interface
...
aplay confirmacao.wav   # Linux
# ou
powershell -c "(New-Object System.Media.SoundPlayer 'confirmacao.wav').PlaySync()" # Windows
```
...
### Exemplo de Vozes Disponíveis

| Voz | Tipo | Características | Melhor Para |
|-----|------|-----------------|-------------|
| **Puck** | Masculina | Clara, amigável, natural | Atendimento geral |
| **Charon** | Masculina | Grave, profissional, autoridade | Executivos, CEO |
| **Kore** | Feminina | Suave, agradável, elegante | Vendas, marketing |
| **Fenrir** | Masculina | Energética, dinâmica, entusiasta | Promoções, engajamento |
| **Zephyr** | Masculina | Equilibrada, versátil, polida | Notificações formais |

## 🎤 Vozes Suportadas

O Gemini 2.5 Flash TTS oferece as seguintes vozes em português:
...
- **Qualidade**: 16-bit
- **Formato**: WAV mono
- **Latência**: ~500ms (dependendo do texto)

### Como Selecionar Vozes via API

```json
{
  "text": "Seu texto aqui",
  "voice": "Puck"  // Altere para: Charon, Kore, Fenrir, Zephyr
}
```
